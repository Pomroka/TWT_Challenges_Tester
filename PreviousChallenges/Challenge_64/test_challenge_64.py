...
from test_cases_ch_64 import test_inp, test_out
...
def test_challenge_64(input: Callable) -> None:
    ...
    with Capturing() as output:
        ...
        import to_submit_ch_64  # change this to your file name with solution without .py extension
