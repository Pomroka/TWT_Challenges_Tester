...
from test_cases_ch_62_2 import test_inp, test_out
...
def test_challenge_62_2(input: Callable) -> None:
    ...
    with Capturing() as output:
        ...
        import challenge_62_2  # change name to your file with solution name without extension
