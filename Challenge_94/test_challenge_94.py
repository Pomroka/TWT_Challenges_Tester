...
class Config:
    ...
    SOLUTION_SRC_FILE_NAME = "to_submit_ch_94.py"
    ...
    # TEST_CASE_FILE = "test_cases_s.json"      #   100 cases 8 digit max
    # TEST_CASE_FILE = "test_cases.json"        #  1000 cases 8 digit max
    # TEST_CASE_FILE = "test_cases_b.json.gz"   # 10000 cases 8 digit max
    # TEST_CASE_FILE = "test_cases_s7.json"     #   100 cases 7 digit max
    TEST_CASE_FILE = "test_cases_7.json"        #  1000 cases 7 digit max
    # TEST_CASE_FILE = "test_cases_b7.json.gz"  # 10000 cases 7 digit max
