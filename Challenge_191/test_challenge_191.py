...
class Config:
    ...
    SOLUTION_SRC_FILE_NAME = "to_submit_ch_191.py"
...
def print_extra_stats(test_inp: TestInp, test_out: TestOut, num_cases: int) -> None:
    ...
    max_h = max(int(x) for x in test_out)
    avg_h = sum(int(x) for x in test_out) // num_cases
    ...
    print(f" - Max Happines: {yellow}{max_h:_}{reset}")
    print(f" - Average Happines: {yellow}{avg_h:_}{reset}")
