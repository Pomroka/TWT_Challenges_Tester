...
from test_cases_ch_57_1 import test_inp, test_out, test_num
...
def test_challenge_57_1(input: Callable) -> None:
    ...
    with Capturing() as output:
        ...
        import to_submit_ch_57_1  # change this to your file name with solution without .py extension
