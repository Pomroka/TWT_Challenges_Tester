...
class Config:
    ...
    SOLUTION_SRC_FILE_NAME = "to_submit_ch_177.py"
...
def print_extra_stats(test_inp: TestInp, test_out: TestOut, num_cases: int) -> None:
    ...
    loose = sum(x == "-1" for x in test_out)
    ...
    print(f" - Max cost: {yellow}{max_c:_}{reset}")
    print(f" - Average cost: {yellow}{avg_c:_}{reset}")
    print(f" - Lost: {yellow}{loose:_}{reset}")
