...
class Config:
    ...
    SOLUTION_SRC_FILE_NAME = "to_submit_ch_199.py"
...
def print_extra_stats(test_inp: TestInp, test_out: TestOut, num_cases: int) -> None:
    ...
    sad = sum(x == ":(" for x in test_out)

    print(f" - Max length S: {yellow}{max_n:_}{reset}")
    print(f" - Average length S: {yellow}{avg_n:_}{reset}")
    print(f" - :( : {yellow}{sad:_}{reset}")
