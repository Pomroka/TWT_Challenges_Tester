...
from test_cases_ch_67 import test_inp, test_out
...
def test_challenge_67(input: Callable) -> None:
    ...
    with Capturing() as output:
        ...
        import to_submit_ch_67  # change this to your file name with solution without .py extension

        end = perf_counter()

    passed = i = 0
    for i, (out, exp, inp) in enumerate(zip_longest(output, test_out, test_inp), 1):
        if out != exp:
