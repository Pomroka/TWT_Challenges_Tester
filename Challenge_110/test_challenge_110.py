...
class Config:
    ...
    SOLUTION_SRC_FILE_NAME = "to_submit_ch_110.py"
    ...
    TEST_CASE_FILE = "test_cases.json.gz"  #  100 test cases max n = 100_000
    # TEST_CASE_FILE = "test_cases_b.json.gz"  # 500 test cases max n = 50_000
