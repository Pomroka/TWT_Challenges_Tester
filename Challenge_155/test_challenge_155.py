...
class Config:
    ...
    SOLUTION_SRC_FILE_NAME = "to_submit_ch_155.py"
...
def print_extra_stats(test_inp: TestInp, test_out: TestOut, num_cases: int) -> None:
    ...
    print(f" - Max number of hamsters: {yellow}{max_n:_}{reset}")
    print(f" - Average number of hamsters: {yellow}{avg_n:_}{reset}")
    print(f" - Max number of apples: {yellow}{max_m:_}{reset}")
    print(f" - Average number of apples: {yellow}{avg_m:_}{reset}")
