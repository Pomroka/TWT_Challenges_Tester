...
from test_cases_ch_58_2 import test_inp, test_out
...
def test_challenge_58_2(input: Callable) -> None:
    ...
    with Capturing() as output:
        ...
        import to_submit_ch_58_2  # change this to your file name with solution without .py extension
