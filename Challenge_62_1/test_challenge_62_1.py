...
from test_cases_ch_62_1 import test_inp, test_out
...
def test_challenge_62_1(input: Callable) -> None:
    ...
    with Capturing() as output:
        ...
        import to_submit_ch_62_1  # change this to your file name with solution without .py extension
