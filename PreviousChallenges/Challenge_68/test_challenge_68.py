...
from test_cases_ch_68 import test_inp, test_out
...
def test_challenge_68(input: Callable) -> None:
    ...
    with Capturing() as output:
        ...
        import to_submit_ch_68  # change this to your file name with solution without .py extension
