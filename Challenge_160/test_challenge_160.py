...
class Config:
    ...
    SOLUTION_SRC_FILE_NAME = "to_submit_ch_160.py"
...
def print_extra_stats(test_inp: TestInp, test_out: TestOut, num_cases: int) -> None:
    ...
    what = sum(x == "???" for x in test_out)

    print(f" - Max len of S: {yellow}{max_n:_}{reset}")
    print(f" - Average len of S: {yellow}{avg_n:_}{reset}")
    print(f" - :what: {yellow}{what:_}{reset}")
