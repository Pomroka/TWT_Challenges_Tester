...
class Config:
    ...
    SOLUTION_SRC_FILE_NAME = "to_submit_ch_158.py"
...
def print_extra_stats(test_inp: TestInp, test_out: TestOut, num_cases: int) -> None:
    ...
    print(f" - Max length of S: {yellow}{max_n:_}{reset}")
    print(f" - Average length of S: {yellow}{avg_n:_}{reset}")
    print(f" - Possible to make palindrome: {yellow}{yes:_}{reset} times")
    print(f" - Impossible to make palindrome: {yellow}{no:_}{reset} times")
