...
class Config:
    ...
    SOLUTION_SRC_FILE_NAME = "to_submit_ch_151.py"
...
def print_extra_stats(test_inp: TestInp, test_out: TestOut, num_cases: int) -> None:
    ...
    print(f" - Max X: {yellow}{max_n:_}{reset}")
    print(f" - Average X: {yellow}{avg_n:_}{reset}")
    print(f" - Max N: {yellow}{max_m:_}{reset}")
    print(f" - Average N: {yellow}{avg_m:_}{reset}")
